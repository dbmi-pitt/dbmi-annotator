...
},{"../../storage":27,"../../util":44,"../editor":36,"../widget":43,"./template":35}],33:[function(require,module,exports){
(function (global){
"use strict";
...
var ddiViewer = exports.ddiViewer = Viewer.extend({
	...
	if (annotation.annotationType == "DDI" && annotation.Drug1 && annotation.Drug2) {
		...
		"<tr><td>" + annotation.Role1 + "</td><td>" + annotation.Role2 + "</td><td>Assertion Type</td><td>Modality</td><td>Evidence modality</td><td>Comment</td></tr>"
