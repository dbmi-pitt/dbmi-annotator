            ...
            this.addField({
                ...
                load: function (field, annotation,annotations) {
                    ...
                    $('#relationship option').each(function () {
                        if (this.value === annotation.relationship) {
                            console.log("[DEBUG] ddieditor - relationship selected");
                            $(this).attr('selected', true);
                            signal = 0;
                        }
                    });
                    ...
                    {
                        console.log("[DEBUG] ddieditor - anno inhibits or substrate of");
                ...
                submit:function (field, annotation) {
                    ...
                    if(annotation.relationship == "inhibits"||annotation.relationship == "substrate of") {
                        ...
                        //console.log("[DEBUG] enzyme saved: " + annotation.enzyme);
                    } else {
                        annotation.enzyme = "";
                    }
...
Template.content = [
  ...
  'function showEnzyme() {',
  'if($("#relationship option:selected").text()=="inhibits"||$("#relationship option:selected").text()=="substrate of") { $("#enzymesection1").show();$("#enzyme").show();console.log("enzyme show");}',
  'if($("#relationship option:selected").text()=="interact with") {$("#enzymesection1").hide();$("#enzyme").hide();console.log("enzyme hide");}',
  '}',
  'function flipdrug() {',
  'var object = $("#Drug1 option:selected").text();',
