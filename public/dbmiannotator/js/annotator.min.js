...
},{"../drugPlugin/editor":30,"../util":44,"./../storage":36,"./../ui/widget":43,"./template":27}],26:[function(require,module,exports){
(function (global){
"use strict";
...
Template.content = [
  ...
  //'<img src="../../../img/arrows-reverse.svg.png">',
  ...
  '<table class="clear-user-agent-styles"><tr><td width="40px"><strong>Modality: </strong></td><td>',
  ...
  '<tr><td width="40px"><strong>Comment: </strong></td><td>',
  ...
  '</a>',
  '      <a ',
  '         id="back" onclick="backtofirst()" style="display:none">',
  'Back',
  '</a>',
  '      <a ',
  '         id="forward" onclick="forwardtosecond()" style="display:none">',
  'Next',
  '</a>',
  '    </div>',
  '  </form>',
...
},{"../util":44,"xpath-range":18}],32:[function(require,module,exports){
"use strict";
